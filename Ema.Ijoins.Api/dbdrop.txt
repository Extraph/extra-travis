 ...
 DROP TABLE public."TB_USER_COMPANY";
 DROP TABLE public."TBM_COMPANY";
 DROP TABLE public."TBM_USER";
 DROP TABLE public."TBM_ROLE";
 ...
 DROP SEQUENCE public."TBM_COMPANY_company_id_seq";
 DROP SEQUENCE public."TBM_ROLE_role_id_seq";
 DROP SEQUENCE public."TB_USER_COMPANY_id_seq";