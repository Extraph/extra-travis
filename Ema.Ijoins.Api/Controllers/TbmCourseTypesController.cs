...
namespace Ema.Ijoins.Api.Controllers
{
  ...
  [ApiController]
  public class TbmCourseTypesController : ControllerBase
  {
    private readonly ema_databaseContext _context;

    public TbmCourseTypesController(ema_databaseContext context)
    {
      _context = context;
    }

    // GET: api/TbmCourseTypes
    [HttpGet]
